...
public class EzCamera : MonoBehaviour
{
    ...
    private void OnApplicationQuit() { m_settings.ResetCameraSettings(); }
    ...
    private Vector3 NewMethod()
    {
        return m_target.position +
            (Vector3.up * m_settings.OffsetHeight) +
    ...
    public void SetCameraTarget(Transform target) { m_target = target; }
    ...
    {
        Vector3 relativePlayerPosition = m_target.position -
            m_transform.position +
            m_transform.right *
            m_settings.LateralOffset;
        ...
        m_transform.rotation = Quaternion.Lerp(m_transform.rotation,
                                               lookAtRotation,
                                               m_settings.RotateSpeed * Time.deltaTime);
    }

    public void UpdatePosition()
    {
        // Update the position of the camera to reflect any rotation changes
        m_settings.OffsetDistance = Mathf.MoveTowards(m_settings.OffsetDistance,
                                                      m_settings.DesiredDistance,
    ...
    public void ZoomCamera(float zDelta)
    {
        ...
        if(!IsOccluded)
        {
            ...
            m_settings.DesiredDistance = Mathf.Clamp(m_settings.OffsetDistance + step,
    ...
    public EzFollowState FollowState { get { return m_followState; } set { m_followState = value; } }
    ...
    public EzLockOnState LockOnState { get { return m_lockOnState; } set { m_lockOnState = value; } }

    public EzOrbitState OrbitState { get { return m_orbitState; } set { m_orbitState = value; } }
    ...
    public EzStationaryState StationaryState { get { return m_stationaryState; } set { m_stationaryState = value; } }
