...
public class EzMotor :Photon.MonoBehaviour 
{
    ...
    [SerializeField] private float m_runSpeed = 35f;
    ...
    private void Start()
    {
        ...
        if (photonView != null)
        {
            ...
            {
                transform.Find("EzCamera").transform.SetParent(null);
                GetComponent<EzMotor>().enabled = false;
            }
        }
